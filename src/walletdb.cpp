...
static u::int64_t nAccountingEntryNumber = 0;
...
bool CWalletDB::WriteAccountingEntry(const u::int64_t nAccEntryNum, const CAccountingEntry& acentry)
{
...
void CWalletDB::ListAccountCreditDebit(const string& strAccount, list<CAccountingEntry>& entries)
{
    ...
    while (true)
    {
        ...
        if (fFlags == DB_SET_RANGE)
            ssKey << boost::make_tuple(string("acentry"), (fAllAccounts? string("") : strAccount), u::int64_t(0));
